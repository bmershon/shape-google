...
class PolyMesh(object):
    ...
    def loadOffFileExternal(self, filename, needsDisplayUpdate = False):
        (self.VPos, self.VColors, self.ITris) = loadOffFileExternal(filename)
        self.needsDisplayUpdate = needsDisplayUpdate
