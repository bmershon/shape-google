...
H0 = shp.makeAllHistograms(PointClouds, Normals, shp.geteD2istogram, 30, 3.0, 1000)
H1 = shp.makeAllHistograms(PointClouds, Normals, shp.getD2Histogram, 30, 3.0, 10000)
...
plt.hold(True)
plt.plot(recalls, PR0, 'r', label='1,000 samples')
plt.plot(recalls, PR1, 'k', label='10,000 samples')
plt.xlabel('Recall')
