...
DEGI = shp.compareHistsEuclidean(HistsEGI)
...
plt.hold(True)
plt.plot(recalls, PRA3, 'r', label='A3')
plt.plot(recalls, PRD2, 'k', label='D2')
plt.plot(recalls, PREGI, 'g', label='EGI')
plt.plot(recalls, PRRandom, 'm', label='Random')
plt.xlabel('Recall')
